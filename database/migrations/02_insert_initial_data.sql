-- Insert initial feature flags (use INSERT IGNORE to avoid duplicate key errors)
INSERT IGNORE INTO feature_flags (name, description, enabled, created_by, updated_by) VALUES
